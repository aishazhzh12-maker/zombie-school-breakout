...
export const levels: Level[] = [
  ...
  {
    id: 3,
    name: "3 этаж · Кабинеты творчества",
    worldW: 3200,
    exitX: 3050,
    classrooms: [
      ...
      { id: "l3a-tech", x: 900, name: "Кабинет труда", loot: { name: "Молоток", emoji: "🔨", strengthGain: 2 }, spots: [
        { id: "s1", where: "shelf", x: 180, item: { name: "Молоток", emoji: "🔨", strengthGain: 2 } },
        { id: "s2", where: "desk", x: 360, item: { name: "Отвёртка", emoji: "🪛", strengthGain: 1 } },
  ...
  {
    id: 4,
    name: "4 этаж · Чердак и складские",
    worldW: 3400,
    exitX: 3250,
    classrooms: [
      { id: "l4-store", x: 350, name: "Склад инвентаря", loot: { name: "Лом", emoji: "⛏️", strengthGain: 2 }, spots: [
        { id: "s1", where: "shelf", x: 180, item: { name: "Лом", emoji: "⛏️", strengthGain: 2 } },
        { id: "s2", where: "drawer", x: 360, item: BATTERY_M },
    ...
    zombies: [
      { id: "l4-z1", x: 550, kind: "trash", name: "Зомби-кладовщик" },
      { id: "l4-z2", x: 1050, kind: "switches", name: "Спящий монтёр", sleeping: true },
